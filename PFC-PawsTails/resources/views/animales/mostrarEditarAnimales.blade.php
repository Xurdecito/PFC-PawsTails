...
<body>
    ...
    <section class="container-fluid contenedor-formulario">
        <form action="/pawsTails/editarAnimal/{{$datosAnimal->id}}" method="POST" enctype="multipart/form-data">
            @csrf
            <h2 class="text-center">Animal: "{{$datosAnimal->nombre}}"</h2>
            @if (session("exito"))
                ...
                <section class="col-10">
                    <section class="card p-4 shadow rounded">
                        <section class="form-floating mb-3">
                            <input type="text" class="form-control color-enfoque" id="nombre" placeholder="Nombre del animal" name="nombre" value="{{$datosAnimal->nombre}}" required>
                        ...
                        <section class="form-floating mb-3">
                            <select class="form-select color-enfoque" id="especie" name="especie" required>
                                ...
                                <option value="perro" @if($datosAnimal->especie == "perro") selected @endif>Perro</option>
                                <option value="gato" @if($datosAnimal->especie == "gato") selected @endif>Gato</option>
                            </select>
                        ...
                        <section class="form-floating mb-3">
                            <textarea class="form-control color-enfoque" id="descripcion" placeholder="Descripción" name="descripcion" required>{{$datosAnimal->nombre}}</textarea>
                        ...
                        <section class="form-group p-2">
                            ...
                            <img src="{{ Storage::url("public/imagenesAnimales/" . $datosAnimal->imagen) }}" width="150"
                            height="150" class="img-fluid p-2 mt-2" alt="{{ $datosAnimal->nombre }}">
                        ...
                        @endif
                        <button type="submit" class="btn btn-formulario">Actualizar los datos de "{{$datosAnimal->nombre}}"</button>
