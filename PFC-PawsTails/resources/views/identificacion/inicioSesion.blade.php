        ...
        <form action="/pawsTails/comprobarLogin" method="post" class="w-50">
            ...
            <section class="card">
                <section class="card-body borde-formulario">
                    ...
                    @endif 
                    <span><img src="{{ asset('imagenesTienda/iconos/mail.png') }}" width="25" height="25" alt="Logo de una direccion de correo"></span>
                    ...
                    <span><img src="{{ asset('imagenesTienda/iconos/lock.png') }}" width="25" height="25" alt="Logo de un candado"></span>
                    <section class="form-floating mb-3">
