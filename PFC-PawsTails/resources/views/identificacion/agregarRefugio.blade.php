                    ...
                    <section class="card p-4 shadow rounded">
                        <section class="form-floating mb-3">
                            <input type="text" class="form-control color-enfoque" id="nombre"
                                placeholder="Nombre del refugio" name="nombre" value="{{ old('nombre') }}" required>
                        ...
                        <section class="form-floating mb-3">
                            <input type="email" class="form-control color-enfoque" id="correo"
                                placeholder="Correo electrónico" name="correo" value="{{ old('correo') }}" required>
                        ...
                        <section class="form-floating mb-3">
                            <input type="text" class="form-control color-enfoque" id="direccion"
                                placeholder="Dirección" name="direccion" value="{{ old('direccion') }}" required>
                        ...
                        <section class="form-floating mb-3">
                            <input type="number" class="form-control color-enfoque" id="telefono"
                                placeholder="Teléfono" name="telefono" value="{{ old('telefono') }}" required>
                        ...
                        <p><a href="/pawsTails"><img
                                    src="{{ asset('imagenesTienda/iconos/arrow-back.png') }}" width="50"
