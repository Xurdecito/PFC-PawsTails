...
<body>
        ...
        <table class="table table-bordered table-striped table-hover table-responsive">
            ...
            @foreach ($usuarios as $usuario)
                <tr>
                    ...
                    <td>{{ $usuario->rol }}</td>
                    <td><a href="/pawsTails/editarUsuario/{{ $usuario->id }}"
                            class="text-primary p-2 herramientas">Editar<img
                                src="{{ asset('imagenesTienda/iconos/edit.png') }}" width="25" height="25"
                                class="img-fluid p-1"></a>
                        <a href="#" class="text-danger p-2 herramientas" data-bs-toggle="modal"
                            data-bs-target="#confirmarBorrarUsuario{{ $usuario->id }}">
                            Borrar <img src="{{ asset('imagenesTienda/iconos/trash.png') }}" width="25"
                                height="25" class="img-fluid p-1">
                        </a>

                        <!--Modal para pedir la confirmación para eliminar a un usuario-->
                        <section class="modal fade" id="confirmarBorrarUsuario{{ $usuario->id }}" tabindex="-1"
                            aria-labelledby="confirmarBorrarUsuarioLabel{{ $usuario->id }}">
                            <section class="modal-dialog">
                                <section class="modal-content">
                                    <section class="modal-header">
                                        <h5 class="modal-title" id="confirmarBorrarUsuarioLabel{{ $usuario->id }}">
                                    ...
                                    <section class="modal-footer">
                                        ...
                                        <a href="/pawsTails/borrarUsuario/{{ $usuario->id }}"
    ...
    <p class="ml-auto"><a href="/pawsTails"><img src="{{ asset('imagenesTienda/iconos/arrow-back.png') }}"
