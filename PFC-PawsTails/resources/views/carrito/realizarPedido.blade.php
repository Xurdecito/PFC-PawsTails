            ...
            <section class="row justify-content-center">
                <section class="col-6">
                    <section class="mb-3">
                        ...
                        <input type="text" class="form-control campo-categoria" id="nombre" name="nombre" placeholder="Ingrese su nombre completo" value="{{ old("nombre", $usuario->nombre) }}" @if($usuario->nombre != null) readonly @endif required>
                        @error("nombre")
                ...
                <section class="col-6">
                    <section class="mb-3">
                        ...
                        <input type="text" class="form-control campo-categoria" id="direccion" name="direccion" placeholder="Ingrese su dirección de envío" value="{{ old("direccion", $usuario->direccion) }}" @if($usuario->direccion != null) readonly @endif required>
                        @error("direccion")
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </section>
                ...
                <section class="col-6">
                    <section class="mb-3">
                        ...
                        <input type="email" class="form-control campo-categoria" id="email" name="email" placeholder="Ingrese su correo electrónico" value="{{ old("email", $usuario->correo) }}" @if($usuario->correo != null) readonly @endif required>
                        @error("email")
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </section>
                ...
                <section class="col-6">
                    <section class="mb-3">
                        ...
                        <input type="tel" class="form-control campo-categoria" id="telefono" name="telefono" placeholder="Ingrese su teléfono de contacto" value="{{ old("telefono", $usuario->telefono) }}" @if($usuario->telefono != null) readonly @endif required>
                        @error("telefono")
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </section>
                ...
                <section class="col-6">
                    <section class="mb-3">
                        ...
                        <input type="text" class="form-control campo-categoria" id="tarjeta" name="tarjeta" placeholder="Ingrese el número de su tarjeta" value="{{ old("tarjeta") }}" required>
                        @error("tarjeta")
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </section>
                ...
                <section class="col-6">
                    <section class="mb-3">
                        ...
                        <input type="text" class="form-control campo-categoria" id="vencimiento" name="vencimiento" placeholder="MM/AA" value="{{ old("vencimiento") }}" required>
                        @error("vencimiento")
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </section>
                ...
                <section class="col-6">
                    <section class="mb-3">
                        ...
                        <input type="text" class="form-control campo-categoria" id="cvv" name="cvv" placeholder="Ingrese el código CVV" value="{{ old("cvv") }}" required>
                        @error("cvv")
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </section>
