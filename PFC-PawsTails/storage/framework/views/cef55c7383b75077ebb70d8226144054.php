...
unset($__errorArgs, $__bag); ?>
                ...
                <section class="form-group p-2">
                    ...
                    <?php if(session('contrasenia')): ?>
                        <section class="text-danger"><?php echo e(session('contrasenia')); ?></section>
                    <?php endif; ?>
                </section>
                ...
                <section class="form-group p-2">
                    ...
                    <?php $__errorArgs = ['contrasenia_nueva'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <section class="form-group p-2">
                    ...
                    <p><a href="/pawsTails"><img src="<?php echo e(asset("imagenesTienda/iconos/arrow-back.png")); ?>" width="50" height="50"  class="img-fluid p-1 aumentoFoto"
...
<?php /**PATH C:\xampp\htdocs\pawsTails\resources\views/identificacion/datosPersonales.blade.php ENDPATH**/ ?>