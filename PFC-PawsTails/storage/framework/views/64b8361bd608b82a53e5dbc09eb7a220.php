...
<body>
    ...
    <section class="container-fluid">
        <h6 class="display-6 separacion text-center">Pedidos realizados en la tienda: "<?php echo e($totalPedidos); ?>" pedidos</h6>
                            ...
                            <section class="card-body">
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="" class="text-danger p-2 herramientas" data-bs-toggle="modal"
                                        data-bs-target="#confirmarModalPedido<?php echo e($pedido['pedido']->id); ?>">
                                ...
                                <section class="modal" tabindex="-1"
                                    id="confirmarModalPedido<?php echo e($pedido['pedido']->id); ?>">
                                    <section class="modal-dialog">
                                        <section class="modal-content">
                                            ...
                                            <section class="modal-body">
                                                ...
                                                "#<?php echo e($pedido['pedido']->id); ?>"?.
                                            </section>
                                            <section class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Cancelar</button>
                                                <a href="/pawsTails/borrarPedido/<?php echo e($pedido['pedido']->id); ?>"
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item border-0">Nombre: <?php echo e($pedido['usuario']->nombre); ?></li>
                                    <li class="list-group-item border-0">Dirección: <?php echo e($pedido['usuario']->direccion); ?>
...
<?php /**PATH C:\xampp\htdocs\pawsTails\resources\views/pedidos/pedidosTienda.blade.php ENDPATH**/ ?>