...
<body>
    ...
    <section class="container d-flex justify-content-center align-items-center">
        <p class="text-danger display-6"><?php echo e($permiso); ?></p>
    </section>
    <section class="container d-flex justify-content-center align-items-center">
        <a href="/pawsTails" class="nav-link"><button type="button" class="btn btn-formulario">Volver a la página principal</button></a>
    </section>
...
<?php /**PATH C:\xampp\htdocs\pawsTails\resources\views/denegado/permiso.blade.php ENDPATH**/ ?>