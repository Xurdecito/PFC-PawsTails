    ...
    <section class="container-fluid">
        ...
        <section class="container-fluid">
            <table class="table">
                ...
                <tbody>
                    <?php $__currentLoopData = $carrito; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $numUnidades++;
                            $total += $articulo->producto->precio * $articulo->cantidad;
                        ?>
                        <tr>
                            <td><img src="<?php echo e(Storage::url('public/imagenesCatalogo/' . $articulo->producto->imagen)); ?>"
                                    width="100" height="100" alt="<?php echo e($articulo->producto->nombre); ?>"></td>
                            <td><?php echo e($articulo->producto->nombre); ?></td>
                            <td><?php echo e($articulo->producto->precio); ?></td>
                            <td><?php echo e($articulo->cantidad); ?></td>
                            <td><?php echo(number_format($articulo->producto->precio * $articulo->cantidad,2,",",".")) ?> €</td>
                            <td>
                                <a href="" class="text-danger p-2 herramientas" data-bs-toggle="modal"
                                    data-bs-target="#confirmarModalCarrito<?php echo e($articulo->id); ?>">
                                ...
                                <section class="modal" tabindex="-1" id="confirmarModalCarrito<?php echo e($articulo->id); ?>">
                                    <section class="modal-dialog">
                                        <section class="modal-content">
                                            ...
                                            <section class="modal-body">
                                                ¿Estás seguro de que deseas eliminar "<?php echo e($articulo->producto->nombre); ?>"
                                                del carrito?.
                                            </section>
                                            <section class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">Cancelar</button>
                                                <a href="/pawsTails/eliminaruno/<?php echo e($articulo->id); ?>"
            ...
            <?php if($numUnidades == 0): ?>
                <section class="container-fluid d-flex justify-content-center separacion">
                    <p class="display-5">Cuando agregues productos a tu carrito se mostraran aquí.</p>
                </section>
            <?php endif; ?>
        </section>
    </section>
    <section class="container-fluid d-flex flex-column justify-content-center text-center separacion">
        <section>
            <p>Total de articulos: <?php echo e($numUnidades); ?>, con un precio total de:
                <?php echo e(number_format($total, 2, ',', '.')); ?>€.</p>
        </section>
...
<?php /**PATH C:\xampp\htdocs\pawsTails\resources\views/carrito/mostrarCarrito.blade.php ENDPATH**/ ?>