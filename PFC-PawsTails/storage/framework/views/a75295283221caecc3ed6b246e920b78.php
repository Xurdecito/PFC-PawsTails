                ...
                <section class="col-10">
                    <section class="card p-4 shadow rounded">
                        <section class="form-floating mb-3">
                            <input type="text" class="form-control color-enfoque" id="nombre" placeholder="Nombre del animal" name="nombre" value="<?php echo e(old("nombre")); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <section class="form-floating mb-3">
                            <select class="form-select color-enfoque" id="especie" name="especie" required>
                                ...
                                <option value="perro" <?php if(old("especie") == "perro"): ?> selected <?php endif; ?>>Perro</option>
                                <option value="gato" <?php if(old("especie") == "gato"): ?> selected <?php endif; ?>>Gato</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <section class="form-floating mb-3">
                            <textarea class="form-control color-enfoque" id="descripcion" placeholder="Descripción" name="descripcion" required><?php echo e(old("descripcion")); ?></textarea>
...
<?php /**PATH C:\xampp\htdocs\pawsTails\resources\views/animales/agregarAnimal.blade.php ENDPATH**/ ?>