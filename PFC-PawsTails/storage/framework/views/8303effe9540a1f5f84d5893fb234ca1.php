...
<body>
                    ...
                    <section class="dropdown ms-auto">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" id="contenedor-menu">
                            <?php $__currentLoopData = $datosMenu['enlaces']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a class="dropdown-item contenedor-dropdown color-nav <?php if($loop->last): ?> ultimo <?php endif; ?>"
    ...
    <?php if(session('sesionIniciada')): ?>
        <section class="container-fluid d-flex justify-content-center">
            <section class="alert alert-success mt-5" role="alert"><?php echo e(session('sesionIniciada')); ?></section>
        </section>
    <?php endif; ?>
    <!--Se mostrara el mensaje de que la sesion del usuario se ha cerrado de manera exitosa-->
    <?php if(session('sesionCerrada')): ?>
        <section class="container-fluid d-flex justify-content-center">
            <section class="alert alert-success mt-5" role="alert"><?php echo e(session('sesionCerrada')); ?><br>¡Esperamos verte pronto por aquí!</section>
        </section>
    <?php endif; ?>
        ...
        <section class="carousel-inner">
            <section class="carousel-item active">
                <section class="row">
                    ...
                    <section class="col-8 p-0">
                        <img src="<?php echo e(asset('imagenesTienda/carrusel/perroygato.jpg')); ?>" alt="Foto de un gato y un perro"
            ...
            <section class="carousel-item">
                <section class="row">
                    ...
                    <section class="col-8 p-0">
                        <img src="<?php echo e(asset('imagenesTienda/carrusel/gatoCarrusel.jpg')); ?>" alt="Foto de un gato echado en el césped"
                            class="img-fluid carrusel">
                    </section>
                </section>
            </section>
    ...
    <section class="container-fluid">
        ...
        <section class="row mb-4">
            ...
            <section class="col-6 infoPrincipal">
                <img src="<?php echo e(asset('imagenesTienda/imagen sin fondo.png')); ?>" class="img-fluid fotoInfo"
                    alt="logo empresa Paws and Tails">
            </section>
        </section>
        ...
        <section class="row mb-4">
            <section class="col-6 infoPrincipal">
                <img src="<?php echo e(asset('imagenesTienda/carrusel/cuidador.png')); ?>" class="img-fluid p-1 fotoInfo"
    ...
    <section class="container-fluid mt-4">
        ...
        <section class="row d-flex justify-content-around mt-4">
            <section class="col-md-4">
                <section class="card">
                    <img src="<?php echo e(asset('imagenesTienda/carrusel/estandaresAlimentarios.jpg')); ?>"
            ...
            <section class="col-md-4">
                <section class="card">
                    <img src="<?php echo e(asset('imagenesTienda/carrusel/refugio.png')); ?>"
            ...
            <section class="col-md-4">
                <section class="card">
                    <img src="<?php echo e(asset('imagenesTienda/carrusel/veterinaria.jpg')); ?>"
...
<?php /**PATH C:\xampp\htdocs\pawsTails\resources\views/index.blade.php ENDPATH**/ ?>